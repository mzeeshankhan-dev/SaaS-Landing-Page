...
export default function Hero() {
  ...
  return (
    <div id="top" className="relative overflow-hidden pt-40 pb-24 lg:pt-48 lg:pb-32">
      {/* Ambient glows */}
      ...
      <Section className="grid grid-cols-1 items-center gap-16 lg:grid-cols-[1fr_1fr] lg:gap-8">
        {/* Left: copy */}
        ...
        >
          <div className="pointer-events-none absolute -inset-10 opacity-70">
            <AINodeField className="h-full w-full" />
          </div>
          ...
          <motion.div
            ...
            className="relative rounded-3xl border border-white/10 bg-void-850/80 p-5 shadow-card backdrop-blur-2xl [transform-style:preserve-3d]"
          >
            {/* header row */}
          ...
          <motion.div
            ...
            className="glass absolute -right-6 -top-6 hidden items-center gap-2.5 rounded-2xl px-4 py-3 shadow-card sm:flex"
          >
